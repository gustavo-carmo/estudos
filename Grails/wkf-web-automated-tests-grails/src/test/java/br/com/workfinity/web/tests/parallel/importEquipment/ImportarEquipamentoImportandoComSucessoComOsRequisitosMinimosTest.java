...
public class ImportarEquipamentoImportandoComSucessoComOsRequisitosMinimosTest extends TestBase {

	private static final String USER_IMPORT_EQUIP_MINIMUM_REQUIRIMENTS = "USER_MINIMUM_REQUI_" + randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_EQUIP_MINIMUM_REQUIRIMENTS, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	@Test(dependsOnMethods = { "background" })
	public void importandoComSucessoUmEquipamentoComOsRequisitosMinimos() {
