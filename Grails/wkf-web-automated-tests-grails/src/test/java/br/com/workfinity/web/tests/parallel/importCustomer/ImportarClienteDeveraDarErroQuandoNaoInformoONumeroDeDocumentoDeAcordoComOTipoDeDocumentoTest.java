...
public class ImportarClienteDeveraDarErroQuandoNaoInformoONumeroDeDocumentoDeAcordoComOTipoDeDocumentoTest
		extends TestBase {

	private static final String USER_IMPORT_CUSTOMER_DOCUMENT_NUMBER_INVALID = "USER_IC_DOC_NUM_INV_" + randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_CUSTOMER_DOCUMENT_NUMBER_INVALID, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	@Test(dependsOnMethods = { "background" })
	public void deveraDarErroQuandoNumeroDeDocumentoNaoForDeAcordoComOTipoDeDocumento() {
		...
		importProcessShowPage.assertEquals("CNPJ inválido", details, "Diferentes!");
	}
}
