...
public class ImportarOSGenericaImportandoComSucessoComTodosOsRequisitosTest extends TestBase {

	private static final String USER_IMPORT_SERVICE_ORDER_GENERIC_ALL_REQUIREMENTS = "USER_ISOG_ALL_REQ_"
			+ randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_SERVICE_ORDER_GENERIC_ALL_REQUIREMENTS, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	@Test(dependsOnMethods = { "background" })
	public void importandoComSucessoUmaOrdemDeServicoGenericaComTodosOsRequisitos() {
