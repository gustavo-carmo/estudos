...
public class ImportarOSGenericaDeveraDarErroQuandoInformoUmTipodeDocumentoInvalidoTest extends TestBase {

	private static final String USER_IMPORT_SERVICE_ORDER_GENERIC_CUSTOMER_DOCUMENT_TYPE_INVALID = "USER_ISOG_CL_DOC_TYPE_INV_"
			+ randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_SERVICE_ORDER_GENERIC_CUSTOMER_DOCUMENT_TYPE_INVALID, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	@Test(dependsOnMethods = { "background" })
	public void deveraDarErroQuandoNoCampoCustomerDocumentNumberTypeNaoForInformadoUmTipoValido() {
		...
		importProcessShowPage.assertEquals("No enum constant br.com.careman.groovy.enums.DocumentType.RG", details,
				"Diferentes!");
	}
}
