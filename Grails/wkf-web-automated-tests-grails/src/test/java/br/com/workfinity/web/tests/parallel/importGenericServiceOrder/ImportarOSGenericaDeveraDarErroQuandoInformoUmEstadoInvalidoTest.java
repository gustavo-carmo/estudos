...
public class ImportarOSGenericaDeveraDarErroQuandoInformoUmEstadoInvalidoTest extends TestBase {

	private static final String USER_IMPORT_SERVICE_ORDER_GENERIC_CUSTOMER_STATE_INVALID = "USER_ISOG_STATE_INV_"
			+ randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_SERVICE_ORDER_GENERIC_CUSTOMER_STATE_INVALID, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	@Test(dependsOnMethods = { "background" })
	public void deveraDarErroQuandoNoCampoCustomerAddressStateNaoForInformadoUmEstadoValido() {
