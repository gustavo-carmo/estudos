...
public class ImportarEquipamentoDeveraDarErroQuandoInformoUmWarrantyCreatedDateNoFormatoInvalidoTest extends TestBase {

	private static final String USER_IMPORT_EQUIP_WARRANTY_CREATE_DATE_INVALID = "USER_IMPEQ_WARRANTY_INV_"
			+ randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_EQUIP_WARRANTY_CREATE_DATE_INVALID, "123456",
	...
	public void deveraDarErroQuandoInformoUmWarrantyCreatedDateNoFormatoInvalido() {
...
//				"object references an unsaved transient instance - save the transient instance before flushing: br.com.careman.domain.Equipment; nested exception is org.hibernate.TransientObjectException: object references an unsaved transient instance - save the transient instance before flushing: br.com.careman.domain.Equipment",
//				details, "Diferentes!");
	}
}
