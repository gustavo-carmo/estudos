...
public class ImportarClienteDeveraDarErroQuandoNaoInformoOCampoStatusTest extends TestBase {

	private static final String USER_IMPORT_CUSTOMER_WHITHOUT_STATUS = "USER_IC_SEM_STATUS_" + randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_CUSTOMER_WHITHOUT_STATUS, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	@Test(dependsOnMethods = { "background" })
	public void deveraDarErroQuandoNaoInformoOCampoStatus() {
		...
		importProcessShowPage.assertEquals("Campo \"status\" é requerido", details, "Diferentes!");
	}
}
