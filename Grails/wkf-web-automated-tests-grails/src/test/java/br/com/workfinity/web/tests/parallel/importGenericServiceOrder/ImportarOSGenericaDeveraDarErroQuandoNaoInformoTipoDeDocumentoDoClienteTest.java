...
public class ImportarOSGenericaDeveraDarErroQuandoNaoInformoTipoDeDocumentoDoClienteTest extends TestBase {

	private static final String USER_IMPORT_SERVICE_ORDER_GENERIC_WITHOUT_DOCUMENT_TYPE = "USER_ISOG_SEM_DOC_TYPE_"
			+ randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_SERVICE_ORDER_GENERIC_WITHOUT_DOCUMENT_TYPE, "123456",
	...
	public void deveraDarErroQuandoNaoInformoOCampoCustomerDocumentNumberType() {
		...
		String status = importProcessShowPage.getStatus("status37");
		importProcessShowPage.assertEquals("Erro", status, "Diferentes!");

		// Verificando o detalhe do erro
		String details = importProcessShowPage.getDetails("val37");
		importProcessShowPage.assertEquals("Name is null", details, "Diferentes!");
	}
}
