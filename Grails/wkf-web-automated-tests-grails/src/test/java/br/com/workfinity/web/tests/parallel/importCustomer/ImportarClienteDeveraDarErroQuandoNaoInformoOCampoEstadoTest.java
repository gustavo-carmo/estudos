...
public class ImportarClienteDeveraDarErroQuandoNaoInformoOCampoEstadoTest extends TestBase {

	private static final String USER_IMPORT_CUSTOMER_WITHOUT_STATE = "USER_IC_SEM_STATE_" + randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_CUSTOMER_WITHOUT_STATE, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	@Test(dependsOnMethods = { "background" })
	public void deveraDarErroQuandoNaoInformoOCampoEstado() {
		...
		importProcessShowPage.assertEquals("Campo \"stateName\" é requerido, Cidade não encontrada", details,
				"Diferentes!");
	}
}
