...
public class ImportarEquipamentoDeveraDarErroQuandoInformoUmApelidoDePrestadorDeServicoInexistenteTest
		extends TestBase {

	private static final String USER_IMPORT_EQUIP_SERVICE_PROVIDER_ALIAS_NONEXISTENT = "USER_IMPEQ_SP_ALIAS_NONE_"
			+ randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_EQUIP_SERVICE_PROVIDER_ALIAS_NONEXISTENT, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	@Test(dependsOnMethods = { "background" })
	public void deveraDarErroQuandoInformoUmAliasDePrestadorDeServicoInexistente() {
		...
		importProcessShowPage.assertEquals("ServiceProvider: INEXISTENTE_PRESTADOR_DE_SERVICO not found.", details,
				"Diferentes!");
	}
}
