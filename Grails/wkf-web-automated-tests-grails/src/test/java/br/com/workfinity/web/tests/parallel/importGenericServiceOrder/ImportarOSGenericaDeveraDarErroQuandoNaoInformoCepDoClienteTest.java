...
public class ImportarOSGenericaDeveraDarErroQuandoNaoInformoCepDoClienteTest extends TestBase {

	private static final String USER_IMPORT_SERVICE_ORDER_GENERIC_WITHOUT_CUSTOMER_ZIPCODE = "USER_ISOG_SEM_CL_ZIP_"
			+ randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_SERVICE_ORDER_GENERIC_WITHOUT_CUSTOMER_ZIPCODE, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	@Test(dependsOnMethods = { "background" })
	public void deveraDarErroQuandoNaoInformoOCampoCustomerAddressZipcode() {
		...
		String status = importProcessShowPage.getStatus("status33");
		importProcessShowPage.assertEquals("Erro", status, "Diferentes!");

		// Verificando o detalhe do erro
		String details = importProcessShowPage.getDetails("val33");
		importProcessShowPage.assertEquals("Endereço: Campo \"CEP\" é requerido", details, "Diferentes!");
	}
}
