...
public class ImportarEquipamentoDeveraDarErroQuandoNaoInformoOCampoSituacaoTest extends TestBase {

	private static final String USER_IMPORT_EQUIP_WITHOUT_SITUTATION = "USER_IMPEQ_SEM_SIT_" + randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_EQUIP_WITHOUT_SITUTATION, "123456",
	...
	public void deveraDarErroQuandoNaoInformoOCampoSituation() {
