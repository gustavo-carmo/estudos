...
public class ImportarClienteDeveraDarErroQuandoNaoInformoOCampoNomeTest extends TestBase {

	private static final String USER_IMPORT_CUSTOMER_WITHOUT_NAME = "USER_IC_SEM_NAME_" + randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_CUSTOMER_WITHOUT_NAME, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	@Test(dependsOnMethods = { "background" })
	public void deveraDarErroQuandoNaoInformoOCampoName() {
		...
		importProcessShowPage.assertEquals("Campo \"name\" é requerido", details, "Diferentes!");
	}
}
