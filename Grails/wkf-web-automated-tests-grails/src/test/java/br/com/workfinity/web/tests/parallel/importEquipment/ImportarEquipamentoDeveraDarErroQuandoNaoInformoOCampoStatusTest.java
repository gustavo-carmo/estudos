...
public class ImportarEquipamentoDeveraDarErroQuandoNaoInformoOCampoStatusTest extends TestBase {

	private static final String USER_IMPORT_EQUIP_WITHOUT_STATUS = "USER_IMPEQ_SEM_STATUS_" + randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_EQUIP_WITHOUT_STATUS, "123456",
	...
	public void deveraDarErroQuandoNaoInformoOCampoStatus() {
		...
		importProcessShowPage.assertEquals(
				"ERROR: [field: status, code: nullable, message: Field \"status\" is required]", details,
				"Diferentes!");
	}
}
