...
public class ImportarClienteDeveraDarErroQuandoInformoUmEstadoInvalidoTest extends TestBase {

	private static final String USER_IMPORT_CUSTOMER_STATE_INVALID = "USER_IC_STATE_INV_" + randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_CUSTOMER_STATE_INVALID, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	@Test(dependsOnMethods = { "background" })
	public void deveraDarErroQuandoInformoUmEstadoInvalido() {
		...
		importProcessShowPage.assertEquals("Estado não encontrado, Cidade não encontrada", details, "Diferentes!");
	}
}
