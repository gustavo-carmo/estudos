...
public class ImportarClienteDeveraDarErroQuandoNaoInformoOCampoTipoDeDocumentoTest extends TestBase {

	private static final String USER_IMPORT_CUSTOMER_WITHOUT_DOCUMENT_TYPE = "USER_IC_SEM_DOC_TYPE_" + randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_CUSTOMER_WITHOUT_DOCUMENT_TYPE, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	@Test(dependsOnMethods = { "background" })
	public void deveraDarErroQuandoNaoInformoOCampoTipoDeDocumento() {
		...
		String status = importProcessShowPage.getStatus("status14");
		importProcessShowPage.assertEquals("Erro", status, "Diferentes!");

		// Verificando o detalhe do erro
		String details = importProcessShowPage.getDetails("val14");
		importProcessShowPage.assertEquals("Campo \"documentType\" é requerido", details, "Diferentes!");
	}
}
