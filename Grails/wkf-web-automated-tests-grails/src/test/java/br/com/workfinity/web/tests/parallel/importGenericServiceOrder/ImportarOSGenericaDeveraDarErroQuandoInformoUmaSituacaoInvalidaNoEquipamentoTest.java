...
public class ImportarOSGenericaDeveraDarErroQuandoInformoUmaSituacaoInvalidaNoEquipamentoTest extends TestBase {

	private static final String USER_IMPORT_SERVICE_ORDER_GENERIC_SITUTATION_INVALID = "USER_ISOG_SIT_INV_"
			+ randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_SERVICE_ORDER_GENERIC_SITUTATION_INVALID, "123456",
	...
	public void deveraDarErroQuandoNoCampoEquipmentSituationInformoUmaSituacaoInvalida() {
