...
public class ImportarOSGenericaDeveraDarErroQuandoInformoUmEquipmentModelNameInexistenteTest extends TestBase {

	private static final String USER_IMPORT_SERVICE_ORDER_GENERIC_MODEL_NONEXISTENT = "USER_ISOG_MODEL_NONE_"
			+ randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_SERVICE_ORDER_GENERIC_MODEL_NONEXISTENT, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	// TODO - verificar porque aceitou modelo de equipamento inexistente
	@Test(dependsOnMethods = { "background" })
	public void deveraDarErroQuandoNoCampoEquipmentModelNameInformoUmEquipmentModelNameInexistente() {
