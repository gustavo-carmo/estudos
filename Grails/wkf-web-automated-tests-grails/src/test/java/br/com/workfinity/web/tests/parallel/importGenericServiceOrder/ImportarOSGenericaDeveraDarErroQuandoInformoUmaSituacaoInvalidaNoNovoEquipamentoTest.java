...
public class ImportarOSGenericaDeveraDarErroQuandoInformoUmaSituacaoInvalidaNoNovoEquipamentoTest extends TestBase {

	private static final String USER_IMPORT_SERVICE_ORDER_GENERIC_NEW_EQUIP_SITUTATION_INVALID = "USER_ISOG_NEQ_SIT_INV_"
			+ randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_SERVICE_ORDER_GENERIC_NEW_EQUIP_SITUTATION_INVALID, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	// TODO - verificar porque aceitou uma situação fora de GOOD, BAD,
	// IRREPARABLE
	@Test(dependsOnMethods = { "background" })
	public void deveraDarErroQuandoNoCampoNewEquipmentSituationInformoUmaSituacaoInvalida() {
