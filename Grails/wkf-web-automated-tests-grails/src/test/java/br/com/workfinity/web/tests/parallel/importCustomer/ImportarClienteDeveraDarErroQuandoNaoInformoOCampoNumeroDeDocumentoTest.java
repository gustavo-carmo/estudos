...
public class ImportarClienteDeveraDarErroQuandoNaoInformoOCampoNumeroDeDocumentoTest extends TestBase {

	private static final String USER_IMPORT_CUSTOMER_WITHOUT_DOCUMENT_NUMBER = "USER_IC_SEM_DOC_NUM_" + randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_CUSTOMER_WITHOUT_DOCUMENT_NUMBER, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	@Test(dependsOnMethods = { "background" })
	public void deveraDarErroQuandoNaoInformoOCampoNumeroDeDocumento() {
		...
		importProcessShowPage.assertEquals("Campo \"documentNumber\" é requerido", details, "Diferentes!");
	}
}
