...
public class ImportarOSGenericaDeveraDarErroQuandoNaoInformoApelidoDeClienteTest extends TestBase {

	private static final String USER_IMPORT_SERVICE_ORDER_GENERIC_WITHOUT_CUSTOMER_ALIAS = "USER_ISOG_SEM_CL_ALIAS_"
			+ randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_SERVICE_ORDER_GENERIC_WITHOUT_CUSTOMER_ALIAS, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	// TODO - Importou com sucesso sem Apelido de Cliente
	@Test(dependsOnMethods = { "background" })
	public void deveraDarErroQuandoNaoInformoOCampoCustomerAlias() {
		...
		String status = importProcessShowPage.getStatus("status34");
		importProcessShowPage.assertEquals("Erro", status, "Diferentes!");

		// Verificando o detalhe do erro
		String details = importProcessShowPage.getDetails("val34");
