...
public class ImportarOSGenericaDeveraDarErroQuandoInformoUmNewEquipmentModelIdInexistenteTest extends TestBase {

	private static final String USER_IMPORT_SERVICE_ORDER_GENERIC_NEW_EQUIP_MODEL_ID_NONEXISTENT = "USER_ISOG_NEQ_MOD_ID_NON_"
			+ randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_SERVICE_ORDER_GENERIC_NEW_EQUIP_MODEL_ID_NONEXISTENT, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	// TODO - verificar porque aceita um id inexistente de novo equipamento
	@Test(dependsOnMethods = { "background" })
	public void deveraDarErroQuandoNoCampoNewEquipmentModelIdInformoUmNewEquipmentModelIdInexistente() {
