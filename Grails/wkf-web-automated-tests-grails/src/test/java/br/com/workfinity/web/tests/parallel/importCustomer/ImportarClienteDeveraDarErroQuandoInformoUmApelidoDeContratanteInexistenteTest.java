...
public class ImportarClienteDeveraDarErroQuandoInformoUmApelidoDeContratanteInexistenteTest extends TestBase {

	private static final String USER_IMPORT_CUSTOMER_CONTRACTOR_ALIAS_NONEXISTENT = "USER_IC_CONTRACTOR_NONE_"
			+ randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_CUSTOMER_CONTRACTOR_ALIAS_NONEXISTENT, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	@Test(dependsOnMethods = { "background" })
	public void deveraDarErroQuandoInformoUmApelidoDeContratanteInexistente() {
