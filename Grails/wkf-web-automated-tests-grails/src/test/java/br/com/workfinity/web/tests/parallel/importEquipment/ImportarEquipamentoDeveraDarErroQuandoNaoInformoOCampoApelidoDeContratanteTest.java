...
public class ImportarEquipamentoDeveraDarErroQuandoNaoInformoOCampoApelidoDeContratanteTest extends TestBase {

	private static final String USER_IMPORT_EQUIP_WITHOUT_CONTRACTOR_ALIAS = "USER_IMPEQ_SEM_CONT_" + randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_EQUIP_WITHOUT_CONTRACTOR_ALIAS, "123456",
	...
	public void deveraDarErroQuandoNaoInformoOCampoContractorAlias() {
		...
		importProcessShowPage.assertEquals(
				"ERROR: [field: stockFromValidator, code: equipment.stockFromValidator.validator.custom.required, message: Contractor or Service Provider or an User is required.]",
				details, "Diferentes!");
	}
}
