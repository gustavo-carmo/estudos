...
public class ImportarClienteDeveraDarErroQuandoNaoInformoOCampoApelidoTest extends TestBase {

	private static final String USER_IMPORT_CUSTOMER_WITHOUT_ALIAS = "USER_IC_SEM_ALIAS_" + randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_CUSTOMER_WITHOUT_ALIAS, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	@Test(dependsOnMethods = { "background" })
	public void deveraDarErroQuandoNaoInformoOCampoApelido() {
		...
		importProcessShowPage.assertEquals("Campo \"alias\" é requerido", details, "Diferentes!");
	}
}
