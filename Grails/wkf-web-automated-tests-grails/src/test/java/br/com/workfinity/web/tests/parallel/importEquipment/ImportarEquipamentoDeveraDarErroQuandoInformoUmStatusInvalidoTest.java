...
public class ImportarEquipamentoDeveraDarErroQuandoInformoUmStatusInvalidoTest extends TestBase {

	private static final String USER_IMPORT_EQUIP_STATUS_INVALID = "USER_IMPEQ_STATUS_INV_" + randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_EQUIP_STATUS_INVALID, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	@Test(dependsOnMethods = { "background" })
	public void deveraDarErroQuandoInformadoUmStatusInvalido() {
		...
		importProcessShowPage.assertEquals(
				"ERROR: [field: status, code: not.inList, message: Property [status] of class [class br.com.careman.domain.Equipment] with value [ABERTO] is not contained within the list [[ENABLED, DISABLED]]]",
				details, "Diferentes!");
	}
}
