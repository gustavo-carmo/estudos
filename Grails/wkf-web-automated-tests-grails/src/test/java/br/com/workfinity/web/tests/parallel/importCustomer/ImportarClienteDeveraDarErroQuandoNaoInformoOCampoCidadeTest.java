...
public class ImportarClienteDeveraDarErroQuandoNaoInformoOCampoCidadeTest extends TestBase {

	private static final String USER_IMPORT_CUSTOMER_WITHOUT_CITY = "USER_IC_SEM_CITY_" + randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_CUSTOMER_WITHOUT_CITY, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	@Test(dependsOnMethods = { "background" })
	public void deveraDarErroQuandoNaoInformoOCampoCidade() {
		...
		importProcessShowPage.assertEquals("Campo \"cityName\" é requerido", details, "Diferentes!");
	}
}
