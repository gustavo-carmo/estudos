...
public class ImportarOSGenericaDeveraDarErroQuandoInformoUmFollowedDateNoFormatoInvalidoTest extends TestBase {

	private static final String USER_IMPORT_SERVICE_ORDER_GENERIC_FOLLOWED_DATE_INVALID = "USER_ISOG_FOL_DATE_INV_"
			+ randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_SERVICE_ORDER_GENERIC_FOLLOWED_DATE_INVALID, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	@Test(dependsOnMethods = { "background" })
	public void deveraDarErroQuandoNoCampoFollowedDateNaoEstiverNoFormatoValido() {
		...
		importProcessShowPage.assertEquals("Unparseable date: \"2016/14/10\"", details, "Diferentes!");
	}
}
