...
public class ImportarClienteDeveraDarErroQuandoInformoUmStatusInvalidoTest extends TestBase {

	private static final String USER_IMPORT_CUSTOMER_STATUS_INVALID = "USER_IC_STATUS_INV_" + randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_CUSTOMER_STATUS_INVALID, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	@Test(dependsOnMethods = { "background" })
	public void deveraDarErroQuandoInformoUmStatusInvalido() {
		...
		importProcessShowPage.assertEquals(
				"Property [status] of class [class br.com.careman.services.importation.importers.CustomerImporterCommandObject] with value [ABERTO] is not contained within the list [[ENABLED, DISABLED]]",
				details, "Diferentes!");
	}
}
