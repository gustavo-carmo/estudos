...
public class ImportarClienteDeveraImportarComSucessoUmClienteComTodosOsRequisitosTest extends TestBase {

	private static final String USER_IMPORT_CUSTOMER_ALL_REQUIREMENTS = "USER_IC_ALL_REQ_" + randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_CUSTOMER_ALL_REQUIREMENTS, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	@Test(dependsOnMethods = { "background" })
	public void importandoComSucessoUmClienteComTodosOsRequisitos() {
