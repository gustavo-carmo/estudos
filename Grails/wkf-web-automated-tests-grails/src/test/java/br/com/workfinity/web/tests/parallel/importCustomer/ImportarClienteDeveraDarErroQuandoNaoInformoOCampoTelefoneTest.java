...
public class ImportarClienteDeveraDarErroQuandoNaoInformoOCampoTelefoneTest extends TestBase {

	private static final String USER_IMPORT_CUSTOMER_WITHOUT_PHONE_NUMBER = "USER_IC_SEM_PHONE_NUM_" + randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_CUSTOMER_WITHOUT_PHONE_NUMBER, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	@Test(dependsOnMethods = { "background" })
	public void deveraDarErroQuandoNaoInformoOCampoNumeroDeTelefone() {
		...
		importProcessShowPage.assertEquals("Campo \"phoneNumber\" é requerido", details, "Diferentes!");
	}
}
