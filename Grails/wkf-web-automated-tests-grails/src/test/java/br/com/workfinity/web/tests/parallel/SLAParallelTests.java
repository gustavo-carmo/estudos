...
public class SLAParallelTests extends TestBase {
	
	private static final String USER_SLA = "USER_SLA_" + randomString(5);
	...
	public void createUserAndDoLogin() throws Exception {
		createUserAndDoLogin(USER_SLA, "123456", userRoles);
	}
