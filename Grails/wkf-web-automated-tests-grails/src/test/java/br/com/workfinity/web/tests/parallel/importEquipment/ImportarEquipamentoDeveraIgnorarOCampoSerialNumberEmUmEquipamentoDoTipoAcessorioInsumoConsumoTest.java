...
public class ImportarEquipamentoDeveraIgnorarOCampoSerialNumberEmUmEquipamentoDoTipoAcessorioInsumoConsumoTest
		extends TestBase {

	private static final String USER_IMPORT_EQUIP_SERIAL_NUMBER_WHEN_DOENST_NEED_SERIAL_NUMBER = "USER_IMPEQ_SNUM_NAO_NEED_SNUM_"
			+ randomString(5);
	...
	public void background() {
		...
		createUserAndDoLogin(USER_IMPORT_EQUIP_SERIAL_NUMBER_WHEN_DOENST_NEED_SERIAL_NUMBER, "123456",
				Arrays.asList("ROLE_IMPORT_PROCESS", "ROLE_IMPORT_PROCESS_FROM_TO"), "pt_BR");
	}

	@Test(dependsOnMethods = { "background" })
	public void deveraIgnorarOCampoSerialNumberEmUmEquipamentoQueNaoRecebeSerialNumber() {
