...
public class TriggerAssociaEquipamentoAoPrestadorDeServicoTest extends TestBase {

	private static final String USER_TRIGGER_ASSOCIATE_EQUIP_SERVICE_PROVIDER = "USER_TR_ASS_EQ_SP_" + randomString(5);
	...
	@Test
	public void loadDataTriggerAssociaEquipamentoAoPrestadorDeServico() {
		...
		createUserAndDoLogin(USER_TRIGGER_ASSOCIATE_EQUIP_SERVICE_PROVIDER, "123456", ROLES, "pt_BR");

		// Acessando a Ordem de Serviço
		serviceOrderCrudForm = new ServiceOrderCrudForm(getDriver(), getBaseUrl(), idServiceOrder);
	}

	@Test(dependsOnMethods = { "loadDataTriggerAssociaEquipamentoAoPrestadorDeServico" })
	public void deveraAcionarOEventoDaTriggerQuandoATriggerDeAssociaOEquipamentoAoPrestadorDeServicosEstaHabilitada() {
