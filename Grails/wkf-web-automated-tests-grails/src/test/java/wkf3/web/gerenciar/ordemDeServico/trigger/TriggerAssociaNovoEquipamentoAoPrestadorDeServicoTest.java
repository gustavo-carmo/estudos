...
public class TriggerAssociaNovoEquipamentoAoPrestadorDeServicoTest extends TestBase {

	private static final String USER_TRIGGER_ASSOCIATE_NEW_EQUIP_SERVICE_PROVIDER = "USER_TR_ASS_NEQ_SP_"
			+ randomString(5);
	...
	@Test
	public void loadDataTriggerAssociaNovoEquipamentoAoPrestadorDeServico() {
		...
		createUserAndDoLogin(USER_TRIGGER_ASSOCIATE_NEW_EQUIP_SERVICE_PROVIDER, "123456", ROLES, "pt_BR");

		// Acessando a Ordem de Serviço
		serviceOrderCrudForm = new ServiceOrderCrudForm(getDriver(), getBaseUrl(), idServiceOrder);
	}

	@Test(dependsOnMethods = { "loadDataTriggerAssociaNovoEquipamentoAoPrestadorDeServico" })
	public void deveraAcionarOEventoDaTriggerQuandoATriggerDeAssociarONovoEquipamentoAoPrestadorDeServicoEstaHabilitada() {
		...
		// Verificando no Estoque se o Novo Equipamento esta com o Prestador de Serviço
