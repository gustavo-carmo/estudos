...
public class MesclarNovoEquipamentoNaOrdemDeServicoEstoqueClienteTest extends TestBase {

	private static final String USER_MERGE_NEW_EQUIP_STOCK_CUSTOMER = "USER_MNEQ_STOCK_CL_" + randomString(5);
	...
	@Test
	public void loadDataMesclarNovoEquipamentoNaOrdemDeServicoEstoqueDoCliente() {
		...
		createUserAndDoLogin(USER_MERGE_NEW_EQUIP_STOCK_CUSTOMER, "123456", ROLES, "pt_BR");

		// Acessando a Ordem de Serviço
		serviceOrderCrudForm = new ServiceOrderCrudForm(getDriver(), getBaseUrl(), idServiceOrder);
	}

	@Test(dependsOnMethods = { "loadDataMesclarNovoEquipamentoNaOrdemDeServicoEstoqueDoCliente" })
	public void deveraMesclarUmNovoEquipamentoDoEstoqueDoClienteComSucessoNaOrdemDeServicoQuandoNoServicoDoContrantateTemAFlagUsarNovoEstoqueDoClienteEstiverHabilitada() {
