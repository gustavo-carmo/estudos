...
public class TriggerSeHouverNovoEquipamentoDesassociaOEquipamentoDoClienteConverteSituacaoParaGoodEDeletaNovoEquipamentoSeEleForTemporarioTest
		extends TestBase {

	private static final String USER_TRIGGER_IF_NEW_EQUIPMENT_DISASSOCIATE_EQUIPMENT_OF_CUSTOMER_KEEP_SITUATION_GOOD_AND_DELETE_NEW_EQUIPMENT_IF_TEMPORARY = "USER_TR_IF_DIS_GOOD_DEL_TP_"
			+ randomString(5);
	...
	@Test
	public void loadDataTriggerSeHouverNovoEquipamentoDesassociaOEquipamentoDoClienteConverteParaSituacaoGoodEDeletaNovoEquipamentoSeEleForTemporario() {
		...
		createUserAndDoLogin(
				USER_TRIGGER_IF_NEW_EQUIPMENT_DISASSOCIATE_EQUIPMENT_OF_CUSTOMER_KEEP_SITUATION_GOOD_AND_DELETE_NEW_EQUIPMENT_IF_TEMPORARY,
				"123456", ROLES, "pt_BR");
	}

	@Test(dependsOnMethods = {
			"loadDataTriggerSeHouverNovoEquipamentoDesassociaOEquipamentoDoClienteConverteParaSituacaoGoodEDeletaNovoEquipamentoSeEleForTemporario" })
	public void deveraAcionarOEventoDaTriggerQuandoATriggerDeSeHouverNovoEquipamentoDesassociaOEquipamentoDoClienteEConverteParaSituacaoGoodEDeletaONovoEquipamentoSeEleForTemporarioEstaHabilitada() {
		...
		// Cria Novo Equipamento Temporario
