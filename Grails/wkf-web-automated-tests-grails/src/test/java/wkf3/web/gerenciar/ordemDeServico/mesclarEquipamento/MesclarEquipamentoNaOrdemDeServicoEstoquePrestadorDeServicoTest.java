...
public class MesclarEquipamentoNaOrdemDeServicoEstoquePrestadorDeServicoTest extends TestBase {

	private static final String USER_MERGE_EQUIP_STOCK_SP = "USER_MEQ_STOCK_SP_" + randomString(5);
	...
	@Test
	public void loadDataMesclarEquipamentoNaOrdemDeServicoEstoqueDoPrestadorDeServico() {
		...
		createUserAndDoLogin(USER_MERGE_EQUIP_STOCK_SP, "123456", ROLES, "pt_BR");

		// Acessando a Ordem de Serviço
		serviceOrderCrudForm = new ServiceOrderCrudForm(getDriver(), getBaseUrl(), idServiceOrder);
	}

	@Test(dependsOnMethods = { "loadDataMesclarEquipamentoNaOrdemDeServicoEstoqueDoPrestadorDeServico" })
	public void deveraMesclarUmEquipamentoDoEstoqueDoPrestadorDeServicoComSucessoNaOrdemDeServicoQuandoNoServicoDaContrantateTemAFlagUsarEstoqueDoPrestadorDeServicoEstiverHabilitada() {
