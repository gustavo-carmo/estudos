...
public class TriggerConverteEquipamentoParaSituacaoBadTest extends TestBase {

	private static final String USER_TRIGGER_CHANGE_EQUIPMENT_TO_BAD = "USER_TR_CHANGE_BAD_" + randomString(5);
	...
	@Test
	public void loadDataTriggerConventerEquipamentoParaSituacaoBad() {
		...
		createUserAndDoLogin(USER_TRIGGER_CHANGE_EQUIPMENT_TO_BAD, "123456", ROLES, "pt_BR");

	}

	@Test(dependsOnMethods = { "loadDataTriggerConventerEquipamentoParaSituacaoBad" })
	public void deveraAcionarOEventoDaTriggerQuandoATriggerDeConverteOEquipamentoParaSituacaoBADstaHabilitada() {

		// Verificando se o Equipamento com Situação Good
