...
public class TriggerConverteNovoEquipamentoParaSituacaoBadTest extends TestBase {

	private static final String USER_TRIGGER_CHANGE_NEW_EQUIPMENT_TO_BAD = "USER_TR_CHANGE_NEQ_BAD_" + randomString(5);
	...
	@Test
	public void loadDataTriggerConventerNovoEquipamentoParaSituacaoBad() {
		...
		createUserAndDoLogin(USER_TRIGGER_CHANGE_NEW_EQUIPMENT_TO_BAD, "123456", ROLES, "pt_BR");
	}

	@Test(dependsOnMethods = { "loadDataTriggerConventerNovoEquipamentoParaSituacaoBad" })
	public void deveraAcionarOEventoDaTriggerQuandoATriggerDeConverteONovoEquipamentoParaSituacaoBADstaHabilitada() {

		// Verificando se o Novo Equipamento com Situação Good
