...
public class TriggerDesassociaNovoEquipamentoDoClienteTest extends TestBase {

	private static final String USER_TRIGGER_DISASSOCIATE_NEW_EQUIP_CUSTOMER = "USER_TR_DIS_NEQ_CL_" + randomString(5);
	...
	@Test
	public void loadDataTriggerDesassociaNovoEquipamentoDoCliente() {
		...
		createUserAndDoLogin(USER_TRIGGER_DISASSOCIATE_NEW_EQUIP_CUSTOMER, "123456", ROLES, "pt_BR");
	}

	@Test(dependsOnMethods = { "loadDataTriggerDesassociaNovoEquipamentoDoCliente" })
	public void deveraAcionarOEventoDaTriggerQuandoATriggerDeDesassociaONovoEquipamentoDoClienteEstaHabilitada() {
		...
		serviceOrderCrudForm.setStatus(TRIGGER_DISASSOCIATE_NEW_EQUIPMENT_OF_CUSTOMER);
		...
		stockControlListPage.validateNotContainsRowInTable(
				Arrays.asList(CUSTOMER_GENERIC + " - " + CUSTOMER_DOCUMENT_NUMBER), "Encontrou o Cliente");
	}
}
