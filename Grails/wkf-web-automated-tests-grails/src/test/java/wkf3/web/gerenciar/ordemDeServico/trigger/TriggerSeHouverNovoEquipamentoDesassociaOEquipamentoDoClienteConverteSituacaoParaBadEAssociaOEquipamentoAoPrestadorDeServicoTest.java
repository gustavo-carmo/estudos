...
public class TriggerSeHouverNovoEquipamentoDesassociaOEquipamentoDoClienteConverteSituacaoParaBadEAssociaOEquipamentoAoPrestadorDeServicoTest
		extends TestBase {

	private static final String USER_TRIGGER_IF_NEW_EQUIPMENT_DISASSOCIATE_EQUIPMENT_OF_CUSTOMER_KEEP_SITUATION_BAD_AND_ASSOCIATE_EQUIPMENT_TO_SERVICE_PROVIDER = "USER_TR_IF_DIS_BAD_AS_SP_"
			+ randomString(5);
	...
	@Test
	public void loadDataTriggerSeHouverNovoEquipamentoDesassociaOEquipamentoDoClienteConverteParaSituacaoGoodEAssociaEquipamentoAoPrestadorDeServico() {
		...
		createUserAndDoLogin(
				USER_TRIGGER_IF_NEW_EQUIPMENT_DISASSOCIATE_EQUIPMENT_OF_CUSTOMER_KEEP_SITUATION_BAD_AND_ASSOCIATE_EQUIPMENT_TO_SERVICE_PROVIDER,
				"123456", ROLES, "pt_BR");

	}

	@Test(dependsOnMethods = {
			"loadDataTriggerSeHouverNovoEquipamentoDesassociaOEquipamentoDoClienteConverteParaSituacaoGoodEAssociaEquipamentoAoPrestadorDeServico" })
	public void deveraAcionarOEventoDaTriggerQuandoATriggerDeSehouverNovoEquipamentoDesassociaOEquipamentoDoClienteConverteParaSituacaoBadEAssociaOEquipamentoAoPrestadorDeServicosEstaHabilitada() {
		...
		stockControlListPage.validateIfContainsTheRowInTable(
				Arrays.asList(serialNumberEquipment, CUSTOMER_GENERIC + " - " + CUSTOMER_DOCUMENT_NUMBER, "Good"));
		...
		// Verificando no Estoque se o Equipamento Esta com o Prestador de
		// Serviço
		...
		stockControlListPage.validateIfContainsTheRowInTable(
				Arrays.asList(serialNumberEquipment, SERVICE_PROVIDER_GENERIC_MATRIZ, "Bad"));
	}
}
