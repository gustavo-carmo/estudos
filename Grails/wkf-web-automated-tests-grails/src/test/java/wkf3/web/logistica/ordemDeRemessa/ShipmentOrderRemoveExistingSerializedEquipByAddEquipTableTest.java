...
public class ShipmentOrderRemoveExistingSerializedEquipByAddEquipTableTest extends TestBase {
	...
	public void backgroundOrdemDeRemessaExcluindoUmEquipamentoSerializado() {
		...
		serialNumber = randomNumber(10);
		
		// Criando o Equipamento do Tipo Acessório
		LoadDataHelper.createEquipment(getDriver(), getBaseUrl(), CONTRACTOR_GENERIC, "", "",
				SERVICE_PROVIDER_GENERIC_MATRIZ, MANUFACTORE_GENERIC, MODEL_GENERIC_PRODUCT, "GOOD", serialNumber, null, false);
	...
	public void verificandoSeOEquipamentoContinuaNaOrigem() {
		...
		stockControlListPage.validateIfContainsTheRowInTable(
				Arrays.asList(CONTRACTOR_GENERIC, SERVICE_PROVIDER_GENERIC_MATRIZ, MODEL_GENERIC_PRODUCT, serialNumber));
	}
}
