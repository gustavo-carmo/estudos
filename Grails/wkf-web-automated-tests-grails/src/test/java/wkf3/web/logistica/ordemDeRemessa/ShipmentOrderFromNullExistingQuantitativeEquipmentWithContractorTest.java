...
public class ShipmentOrderFromNullExistingQuantitativeEquipmentWithContractorTest extends TestBase {
	...
	public void backgroundOrdemDeRemessaEquipamentoQuantitativoSemOrigem() {
		...
		LoadDataHelper.createEquipment(getDriver(), getBaseUrl(), CONTRACTOR_GENERIC, "", "", SHIP_SERVICE_PROVIDER, MANUFACTORE_GENERIC,
	...
	public void verificandoSeFoiAdicionadoOEquipamentoQuantitativoNoDestinoAposFinalizarARemessa() {
		...
		stockControlListPage.validateIfContainsTheRowInTable(
				Arrays.asList(CONTRACTOR_GENERIC, SHIP_SERVICE_PROVIDER, "Bad", MODEL_SHIP_ACCESSORY, "75"));
	}
}
