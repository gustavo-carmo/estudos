...
public class ShipmentOrderCheckOriginAndDestinyQuantitativeEquipWithoutContractorTest extends TestBase {
	...
	private static final String MODEL_SHIP_ACCESSORY = "MODEL_SHIP_ACCESSORY_" + randomString(5);
	...
	public void backgroundOrdemDeRemessaEquipamentoQuantitativo() {
		...
		LoadDataHelper.createEquipment(getDriver(), getBaseUrl(), "", "", "", SERVICE_PROVIDER_GENERIC_MATRIZ,
				MANUFACTORE_GENERIC, MODEL_SHIP_ACCESSORY, "GOOD", "", 100, false, poAndSi, poAndSi);
	...
	public void sucessoAoAdicionarUmQuantitativoSemContratanteNaOrdemDeRemessa() {
		...
		addAccessoryComponentOrSupply.setQuantity("80");
		...
		addAccessoryComponentOrSupply.validateIfContainsTheRowInTableByCssSelector(
				Arrays.asList(MODEL_SHIP_ACCESSORY, "80"),
				"#collapseOne .table.table-bordered.table-striped.table-condensed > tbody > tr",
				"Erro na validação da tabela de sucesso");
	}

	@Test(dependsOnMethods = { "sucessoAoAdicionarUmQuantitativoSemContratanteNaOrdemDeRemessa" })
	public void verificandoSeFoiAbatidoAQuantidadeDoEquipamentoNoEstoqueDaOrigemAntesDeFinalizarARemessa() {
...
//		stockControlListPage.setModel(MODEL_SHIP_ACCESSORY);
		...
		stockControlListPage.validateIfContainsTheRowInTable(
				Arrays.asList(SERVICE_PROVIDER_GENERIC_MATRIZ, "Good", MODEL_SHIP_ACCESSORY, "20"));
	}

	@Test(dependsOnMethods = {
			"verificandoSeFoiAbatidoAQuantidadeDoEquipamentoNoEstoqueDaOrigemAntesDeFinalizarARemessa" })
	...
	public void verificandoSeFoiDepositadoNoDestinoAQuantidadeDoEquipamento() {
		...
		stockControlListPage.validateIfContainsTheRowInTable(
				Arrays.asList(SHIP_SERVICE_PROVIDER, MODEL_SHIP_ACCESSORY, "80"));
	}
}
