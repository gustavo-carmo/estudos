...
public class ShipmentOrderFromNullNewSerializedEquipTest extends TestBase {
	...
	public void sucessoAoAdicionarUmEquipamentoSerializadoNaOrdemDeRemessa() {
		...
		// Gerando um número de serie
		serialNumberProduct = randomNumber(6);
		...
		shipmentOrderAddEquipment.validateIfContainsTheRowInTableByCssSelector(
				Arrays.asList(MODEL_GENERIC_PRODUCT, serialNumberProduct),
	...
	public void verificandoSeOEquipamentoSerializadoFoiCriadoNoDestino() {
		...
		stockControlListPage.validateIfContainsTheRowInTable(
				Arrays.asList(SHIP_SERVICE_PROVIDER, serialNumberProduct));
	}
}
