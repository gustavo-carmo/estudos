...
public class ShipmentOrderCheckDestinyExistingSerializedEquipWithoutContractorTest extends TestBase {
	...
	public void backgroundOrdemDeRemessaEquipamentoSerializado() {
		...
		LoadDataHelper.createEquipment(getDriver(), getBaseUrl(), "", "", "",
